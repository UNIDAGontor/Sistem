...
(function() {
  ...
  // ===== KONFIGURASI BACKEND =====
  const API_CONFIG = {
    BASE_URL: 'https://script.google.com/macros/s/AKfycbwP73vflHRqSIayfu_IJxmeoz_DXohP_8G289JgjqV7TaXV8mhKhGXmP4zyz6kcjILi/exec',
    MODULE: 'agenda',
...
function mapToFrontend(backendData) {
  ...
  function renderLeftPanel() {
    ...
    if (!bigDate || !bigDay || !eventsListLeft) return;
    
    var d = selectedDate;
    bigDate.textContent = d.getDate();
    bigDay.textContent = dayNamesFull[d.getDay()].toUpperCase();
